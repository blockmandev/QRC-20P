...
use super::super::fees_usd::{USDFeeSystem, TransactionFeeType};
use super::super::common_types::{TokenId, TokenMode};
...
impl StateConnector {
    ...
    async fn set_storage_u256(
        ...
        state.set_storage(address, key, H256::from_slice(&bytes))
    }
...
mod tests {
    use super::*;
    use super::super::super::state::GlobalState;
    use super::super::super::fees_usd::{USDFeeSystem, FeeConfig};
    use super::super::super::common_types::TokenId;
